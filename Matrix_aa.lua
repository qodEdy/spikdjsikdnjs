...
client.color_log(21, 235, 220,  "                       Welcome " .. "!            ")
client.color_log(235, 221, 21,  "                    Last Updated: 14/7/2021.              ")
client.color_log(255, 255, 255, "|--------------------------------------------------------|")
...
local mshit = {
	...
	faster_dt = ui.new_checkbox("RAGE", "Other", "Faster Doubletap"),
	adaptive_dt = ui.new_checkbox("RAGE", "Other", "Ping Based Doubletap"),
	TwinTower_enabled = ui.new_checkbox("MISC", "Miscellaneous", "Kryptonite - Clantag"),
	...
	doubletap_icons_ideal = ui.new_checkbox("AA", "Anti-aimbot angles", "Compatible with Tibzzy Ideal Tick"),
	...
	label2 = ui.new_label("AA", "Anti-aimbot angles", "Kryptonite Indicator Color"),
	...
	label21 = ui.new_label("AA", "Anti-aimbot angles", "Dormant AA Type Color"),
	color21  = ui.new_color_picker("AA", "Anti-aimbot angles", "Indicator color21", 255, 255, 255, 255),
	
	label22 = ui.new_label("AA", "Anti-aimbot angles", "Freestanding AA Type Color"),
	color22  = ui.new_color_picker("AA", "Anti-aimbot angles", "Indicator color22", 255, 255, 255, 255),
	...
	label19 = ui.new_label("AA", "Anti-aimbot angles", "Doubletap Bullet Icon Color"),
	color19 = ui.new_color_picker("AA", "Anti-aimbot angles", 'Indicator color19', 255, 255, 255, 255),
	
	label20 = ui.new_label("AA", "Anti-aimbot angles", "Weapon Icon Color"),
	color20 = ui.new_color_picker("AA", "Anti-aimbot angles", 'Indicator color20', 255, 255, 255, 255),
}
	...
	if entity.is_alive(local_player) then
		if ui.get(mshit.autobuy_options) == "AWP" then
			if weapon_name ~= "CWeaponAWP" then
				client.exec("buy awp;")
				client.color_log(3, 252, 119, "[Kryptonite] Tried buying awp at: ", difference)
			end
		elseif ui.get(mshit.autobuy_options) == "SCOUT" then
			if weapon_name ~= "CWeaponSSG08" then
				client.exec("buy ssg08;")
				client.color_log(3, 252, 119, "[Kryptonite] Tried buying scout at: ", difference)
			end
		end
	end
end
...
local function on_setup_command(c)
	...
	if variables.auto_rage then
		...
		if ui_get(deez_nutz[variables.p_state].aa_mode_shit) == "Kryptonite" then
...
local function on_paint()
	...
	if ui.get(mshit.visual_text) then	
		renderer.text(center[1], center[2] + 17,  color_g2[1], color_g2[2], color_g2[3], color_g2[4], "-c", 0, "Kryptonite  AA" )
...
local function disable_aa()
	...
	ui_set(deez_nutz[1].aa_mode_shit, "Kryptonite")
...
local function enable_aa()
	...
	ui_set(deez_nutz[2].aa_mode_shit, "Kryptonite")
	...
	ui_set(deez_nutz[3].aa_mode_shit, "Kryptonite")
	...
	--moving (scoped)
		...
		ui_set(deez_nutz[8].aa_mode_shit, "Kryptonite")
	...
	ui_set(deez_nutz[4].aa_mode_shit, "Kryptonite")
	...
	ui_set(deez_nutz[5].aa_mode_shit, "Kryptonite")
	...
	ui_set(deez_nutz[6].aa_mode_shit, "Kryptonite")
	...
	if entity.get_prop(entity.get_local_player(), 'm_iTeamNum') == 2 then 
		...
		ui_set(deez_nutz[7].aa_mode_shit, "Kryptonite")
		if p_still2 then
	...
	ui_set(deez_nutz[9].aa_mode_shit, "Kryptonite")
	if jafeth == true then
	...
	ui_set(deez_nutz[10].aa_mode_shit, "Kryptonite")
